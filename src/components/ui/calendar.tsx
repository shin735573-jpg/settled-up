  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-12 w-12 p-0 font-normal text-base aria-selected:opacity-100"),
      ...
      modifiersClassNames={{
        koreanHoliday: "text-pink-600 font-bold bg-pink-50 hover:bg-pink-100",
        sunday: "text-red-600",
        ...(modifiersClassNames || {}),
      }}
      components={{
