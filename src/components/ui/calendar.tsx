  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell: "text-muted-foreground rounded-md w-14 font-semibold text-sm",
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-14 w-14 p-0 font-normal text-base aria-selected:opacity-100"),
      ...
      modifiers={{
        koreanHoliday: (date: Date) => isKoreanHoliday(date),
        sunday: (date: Date) => date.getDay() === 0,
        ...(modifiers || {}),
      }}
      modifiersClassNames={{
        koreanHoliday: "text-red-600 font-bold bg-red-100 hover:bg-red-200",
        sunday: "text-red-600",
        ...(modifiersClassNames || {}),
      }}
      components={{
