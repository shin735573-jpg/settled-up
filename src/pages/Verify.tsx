        ...
        <>
          <Card className="p-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
              ...
              <Stat label="업체 표시 합계" value={fmt(result.companyDisplayTotal)} />
              <Stat label="업체 청구 합계(VAT포함)" value={fmt(result.companyClaimTotal)} />
              <Stat label="팀장 배분 합계" value={fmt(result.leaderShareTotal)} />
              <Stat label="팀장 실지급(VAT포함)" value={fmt(result.leaderPayoutTotal)} />
